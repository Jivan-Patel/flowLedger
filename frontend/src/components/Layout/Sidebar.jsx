...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 h-screen fixed left-0 top-0 bg-[#060e20] shadow-[1px_0_0_0_rgba(255,255,255,0.05)] flex flex-col py-8 px-4 z-50">
      {/* Branding */}
      <div className="mb-10 px-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tighter text-[#b4c5ff]">FlowLedger</h1>
            <p className="text-[10px] uppercase tracking-widest text-on-surface-variant opacity-60">Financial Dashboard</p>
          </div>
        </div>
      </div>
